...
#class global_parameters(object):
    ...
    def set_bg_params(self):
        ...
        self.params['tau_p'] = 5000. #1000.
        self.params['gain'] = 7. #2.5 ##1.9   #3.
        self.params['gain_d1'] = 7. # 1. ##1.9   #3.
        self.params['gain_d2'] = 7. # 1. ##1.9   #3.
        self.params['gain_rp'] = -3.
        self.params['gain_dopa'] = 6.  #5.   #4.
        self.params['gain_neuron'] = 40.       #gain for the neuron model has different impact (amplifies current injected) than gain in synapse model (amplifies weights)
        self.params['K'] = 0.
        self.params['fmax'] = 50. #100.  #70
        self.params['rp_fmax'] = 60.   #self.params['fmax']
        self.params['Vth'] = -50.
        self.params['Cm'] = 260.  #250.
        self.params['Vreset'] = -75.
        self.params['gL'] = 16.6667
        self.params['temperature'] = 3.

        self.params['Cm_std'] = 1. #0.01  #25.
       ...
       # self.params['inactive_poisson_rew_rate'] = 2300.
        ...
        self.params['str_to_output_exc_w'] = 3.             ### D2
       ...
       # self.params['p_ij']= (np.random.random()/33.)*(np.random.random()/33.)
        self.params['p_ij']= (np.random.random()/33.)*(self.params['p_j'])
       ...
       # self.params['p_ij']= self.params['p_i'] * self.params['p_j']
        ...
        self.params['inhib_lateral_weights_d2'] = -2. #-4.
        self.params['inhib_lateral_weights_d2_d1'] = -1. #-4.
        self.params['inhib_lateral_delay_d1'] = 1.
        self.params['inhib_lateral_delay_d2'] = 1.
        self.params['ratio_lat_inh_d1_d1'] = 4.   # ratio of D1 MSNs belonging to the other actions inhibited by one D1 MSN from a specific action  
        self.params['ratio_lat_inh_d2_d2'] = 4.   # ratio of D1 MSNs belonging to the other actions inhibited by one D1 MSN from a specific action
        ...
        self.params['active_full_efference_rate'] = 3000.   #2000.#600.  #3000.
        ...
        self.params['initial_noise_striatum_rate'] = 5000.  #2500.
       ...
       # self.params['delay_actions_rp'] =  self.params['t_efference']
        ...
        # NOISE 
        # =========================
        self.params['noise_weight_d1_exc']= 1. 
        self.params['noise_weight_d1_inh']= 1. 
        self.params['noise_weight_d2_exc']= 1.
        self.params['noise_weight_d2_inh']= 1.
